...
public abstract class ExtendedRdfWriter implements ExtendedWriter {
    ...
    /** the generator */
    ExtendedGenerator generator;

    /**
     * Constructor.
     * @param generator The generator object.
     */
    public ExtendedRdfWriter(ExtendedGenerator generator) {
    ...
    public void startSection(int classType, String id) {
        ...
        out.println();
        String s = "<" + T_ONTO_PREFIX + ExtendedGenerator.CLASS_TOKEN[classType] + T_SPACE
                + T_RDF_ABOUT + "=\"" + id + "\">";
        out.println(s);
    }
    ...
    public void endSection(int classType) {
        String s = "</" + T_ONTO_PREFIX + ExtendedGenerator.CLASS_TOKEN[classType] + ">";
        out.println(s);
    }
    ...
    public void addProperty(int property, String value, boolean isResource) {
        ...
        String s;
        if (isResource) {
            s = "   <" + T_ONTO_PREFIX + ExtendedGenerator.PROP_TOKEN[property] + T_SPACE
                    + T_RDF_RES + "=\"" + value + "\" />";
        } else { //literal
            s = "   <" + T_ONTO_PREFIX + ExtendedGenerator.PROP_TOKEN[property] + ">" + value
                    + "</" + T_ONTO_PREFIX + ExtendedGenerator.PROP_TOKEN[property] + ">";
        }
    ...
    public void addProperty(int property, int valueClass, String valueId) {
        ...
        String s;
        s = "   <" + T_ONTO_PREFIX + ExtendedGenerator.PROP_TOKEN[property] + ">\n"
                + "      <" + T_ONTO_PREFIX + ExtendedGenerator.CLASS_TOKEN[valueClass] + T_SPACE
                + T_RDF_ABOUT + "=\"" + valueId + "\" />"
                + "   </" + T_ONTO_PREFIX + ExtendedGenerator.PROP_TOKEN[property] + ">";
    ...
    public void tdki_addConceptAssertion(String concept, String name) {
        out.println();
        out.println("<" + T_ONTO_PREFIX + concept + T_SPACE + T_RDF_ABOUT + "=\"" + name + "\"" + "/>");
    }
}
